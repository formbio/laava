...
class TestCompareTSVs:
    ...
    # Flipflop tests for SS and TC-GIA-012
    ...
    def test_tc_gia_012_flipflop(self, build_dir):
        self.check_tsv_row_count(build_dir, "tc-gia-012", "flipflop", "tsv.gz")

    def test_tc_gia_012_agg_flipflop(self, build_dir):
        self.check_tsv_row_count(build_dir, "tc-gia-012", "agg_flipflop", "tsv")
