...
p1.err_sub <- ggplot(filter(df.err.vector, type == 'mismatch'),
  ...
  labs(title = "Nucleotide substitutions along vector genome",
       subtitle = "Counts binned by 10 nucleotides (NTs) (y-axis) and position (x-axis) for substitutions in all full vector genomes (including the ITRs)",
...
p1.err_del <- ggplot(filter(df.err.vector, type == 'deletion'),
  ...
  labs(title = "Nucleotide deletions along vector genome",
       subtitle = "Counts binned by 10 nucleotides (NTs) (y-axis) and position (x-axis) for deletions in all full vector genomes (including the ITRs)",
       x = "Reference position") +
  scale_y_continuous("Counts",
                     limits = c(0, NA),
                     expand = expansion(mult = c(0, 0.05)))
...
p1.err_ins <- ggplot(filter(df.err.vector, type == 'insertion'),
  ...
  labs(title = "Insertions by reference position",
       subtitle = "Counts binned by 10 nucleotides (NTs) (y-axis) and position (x-axis) for insertions in all full vector genomes (including the ITRs)",
       x = "Reference position") +
  scale_y_continuous("Counts",
                     limits = c(0, NA),
                     expand = expansion(mult = c(0, 0.05)))
